...
(function ($) {
    ...
    $('#sortbyfirstname').click(function(){
        console.log("asadf");
        var mylist = $('.lightbox:not(:hidden)').parent();
        var listitems = $('.lightbox:not(:hidden)');
        listitems.sort(function(a, b) {
           var compA = $(a).attr("data-caption").toUpperCase();
           var compB = $(b).attr("data-caption").toUpperCase();
    ...
    if( getUrlParameter('page') === "approve"){
    ...
    $(document).keydown(function(event){
    	if(event.which=="17" && isApprovePage){
			controlPressed = true;
	...
	$(document).keyup(function(){
		...
		if (controlPressed === false && isApprovePage){
			$('.lightbox').each(function(index, element){
