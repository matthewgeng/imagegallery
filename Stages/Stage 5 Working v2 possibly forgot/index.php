<?php
	...
	if ($page == "validated"){
	...
	} elseif ($page == "form" || $uploadOk !== 1 && $uploadOk != 10){
		include "content.inc";
		...
		for ($i=0; $i<count($files); $i++){
			...
			echo '<a href="'.$num.'" data-fancybox="gallery"  data-caption="'.$firstname . " " . $lastname . "<br> " .$description.'" class="lightbox"><img src="'.$thumb.'"/></a>';
		}
	}
