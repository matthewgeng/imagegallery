...
/* session_destroy();  */
	...
	$jsonstring = "";
		...
		for ($i=0; $i<count($files); $i++){
			...
			echo '<div class="' .$number.'""><a href="'.$num.'" class=" lightbox thumbnail" data-fancybox="gallery"  data-caption="'.$firstname . " " . $lastname . "<br> " .$description.'" class="lightbox"><img class="img-responsive" src="'.$thumb.'" /></a></div>';
	...
	$jsonstring = "";
		...
		for ($i=0; $i<count($files); $i++){
			...
			echo '<div class="' .$number.'"><a href="'.$num.'" class=" lightbox thumbnail " data-fancybox="gallery"  data-caption="'.$firstname . " " . $lastname . "<br> " .$description.'" ><img class="img-responsive" src="'.$thumb.'"/></a></div>';
			}
		}
	}
